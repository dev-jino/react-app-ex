  ...
  return (
    <div>
      ...
      <input type="number"
        ...
        step="10" />
      <button onClick={() => { dispatch({type:ACTION_TYPES.up, payload : number}); }}>up</button>
      <button onClick={() => { dispatch({type:ACTION_TYPES.down, payload : number}); }}>down</button>
    </div>
  );
}
